...
function LatePermission() {
  const { latePermissionRequests, studentUploadsURL, updateLatePermission } =
  ...
  return (
    <div className="container late-permission-requests p-4">
      <h2 className="m-0">Late Entry Permission</h2>
      ...
      <table className="w-100">
        ...
        <tbody className="text-center">
          {latePermissionRequests.map((request, index) => {
            return (
      ...
      >
        ...
        <div className="m-2 text-center">
          ...
          <button
            ...
            onClick={() => {
              updateLatePermission(selectedRequest._id, "accepted");
              closeModal();
            }}
          >
            Accept
          ...
          <button
            ...
            onClick={() => {
              updateLatePermission(selectedRequest._id, "rejected");
              closeModal();
            }}
          >
            Reject
